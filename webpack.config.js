...
module.exports = {
  ...
  // devtool - настройка, которая позволяет добавлять карты кода - это специальные файлы, внутри которых сохранена структура кода до его минимификации. Таким образом, если открыть в браузере вкладку Source, то в поле webpack:// мы найдем реальную структуру проекта, которую можно использовать для отладки
  devtool: 'source-map',
};
